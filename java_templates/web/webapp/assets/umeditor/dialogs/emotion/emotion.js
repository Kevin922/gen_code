(function(){
    ...
    UM.registerWidget('emotion',{
        ...
        initContent:function( _editor, $widget ){
            ...
            emotion.SmileyPath = _editor.options.emotionLocalization === true ? emotionUrl + 'images/' : "http://static.dili7.com/static/common/umeditor/dialogs/emotion/images/";
            emotion.SmileyBox = me.createTabList( emotion.tabNum );
            emotion.tabExist = me.createArr( emotion.tabNum );

            options['cover_img'] = emotion.SmileyPath + (editor.options.emotionLocalization ? '0.gif' : '0.gif');
